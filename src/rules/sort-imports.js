/**
 * @fileoverview Rule to require sorting of import declarations. Forked from ESLint's sort-imports rule
 */
...
const importTypes = ['none', 'all', 'named', 'default']
...
module.exports = {
  ...
  create(context) {
     ...
     */
    function usedMemberSyntax({ specifiers }) {
    ...
    function getFirstLocalMemberName(node) {
      if (node.specifiers[0]) return node.specifiers[0].local.name
