...
export default class TranspositionManager {
  constructor(nodes) {
    this.nodes = nodes
  ...
  transpose() {
    ...
    while (workNode === this.workOn && this.workOn > 0)
      workNode = this.virtualTransposedState[--this.workOn].shouldBe // eslint-disable-line
